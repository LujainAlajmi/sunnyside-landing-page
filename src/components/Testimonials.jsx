...
function Testimonials() {
  return (
    <div>
      ...
      {/* desktop settings */}
      <div className="sm:flex flex-col w-screen text-center justify-center items-center py-28 text-DarkGrayishBlue   bg-[#fefbf8] xs:hidden">
        <h1 className=" uppercase tracking-widest text-3xl py-16">
          Client testimonials
        </h1>
